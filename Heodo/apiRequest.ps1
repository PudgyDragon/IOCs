# PowerShell script for getting Heodo hash values from MalwareBazaar
(Invoke-Webrequest -Method POST -Body "query=get_siginfo&signature=Heodo&limit=1000" -Uri https://mb-api.abuse.ch/api/v1/).Content | Out-File -FilePath "C:\path\to\file.json"
